...
<div class="container">
    ...
    <div id="download" class="tab-content">
        <div class="card" style="background: #2b4a6f; border: 1px solid #4a7ba7; margin-bottom: 15px; padding: 12px;">
            <strong style="color: #8be9fd;">💡 Quick Guide:</strong> Test download speeds and server performance. Select size and file type, then click Start. The file will download automatically. Use "Random Data" for realistic testing (doesn't compress).
        </div>
        <div class="card">
    ...
    <div id="upload" class="tab-content">
        <div class="card" style="background: #2b4a6f; border: 1px solid #4a7ba7; margin-bottom: 15px; padding: 12px;">
            <strong style="color: #8be9fd;">💡 Quick Guide:</strong> Test upload speeds by sending random data to the server. Select size and chunk size (larger chunks = faster uploads but more memory). Data is discarded after upload.
        </div>
        <div class="card">
    ...
    <div id="stress" class="tab-content">
        <div class="card" style="background: #2b4a6f; border: 1px solid #4a7ba7; margin-bottom: 15px; padding: 12px;">
            <strong style="color: #8be9fd;">💡 Quick Guide:</strong> Send many requests simultaneously to test server capacity and load balancing. Start with 100 requests / 10 concurrent. Check if different backend servers handle requests (HAProxy testing).
        </div>
        <div class="card">
    ...
    <div id="websocket" class="tab-content">
        <div class="card" style="background: #2b4a6f; border: 1px solid #4a7ba7; margin-bottom: 15px; padding: 12px;">
            <strong style="color: #8be9fd;">💡 Quick Guide:</strong> Test WebSocket connectivity through your proxy. Default URL uses a public echo server for testing. Connect, send messages, and verify they echo back. Critical for testing proxy WebSocket support.
        </div>
        <div class="card">
    ...
    <div id="headers" class="tab-content">
        <div class="card" style="background: #2b4a6f; border: 1px solid #4a7ba7; margin-bottom: 15px; padding: 12px;">
            <strong style="color: #8be9fd;">💡 Quick Guide:</strong> Add custom HTTP headers to test how they're handled by your server and proxy. Headers are auto-prefixed with "X-Custom-". Useful for testing authentication headers and proxy header forwarding.
        </div>
        <div class="card">
    ...
    <div id="sticky" class="tab-content">
        <div class="card" style="background: #2b4a6f; border: 1px solid #4a7ba7; margin-bottom: 15px; padding: 12px;">
            <strong style="color: #8be9fd;">💡 Quick Guide:</strong> Test if your load balancer maintains session stickiness. Sends multiple requests with the same session cookie. Result should be "✓ STICKY" (all requests hit same server). If "✗ NOT STICKY", check load balancer configuration.
        </div>
        <div class="card">
    ...
    <div id="parallel" class="tab-content">
        <div class="card" style="background: #2b4a6f; border: 1px solid #4a7ba7; margin-bottom: 15px; padding: 12px;">
            <strong style="color: #8be9fd;">💡 Quick Guide:</strong> Open multiple connections simultaneously to test connection limits. Set how many connections and how long to hold them open. Useful for finding proxy/server connection limits and testing timeout settings.
        </div>
        <div class="card">
    ...
    <div id="cookies" class="tab-content">
        <div class="card" style="background: #2b4a6f; border: 1px solid #4a7ba7; margin-bottom: 15px; padding: 12px;">
            <strong style="color: #8be9fd;">💡 Quick Guide:</strong> Create and manage cookies for testing. Note: PHPSESSID and HttpOnly cookies won't appear here (browser security). Use F12 → Storage/Application tab to see all cookies including PHPSESSID.
        </div>
        <div class="card">
    ...
    <div id="useragent" class="tab-content">
        <div class="card" style="background: #2b4a6f; border: 1px solid #4a7ba7; margin-bottom: 15px; padding: 12px;">
            <strong style="color: #8be9fd;">💡 Quick Guide:</strong> Test requests with different user-agent strings. Select a preset (Chrome, Firefox, bots) or enter custom. Useful for testing how your server handles different browsers and web crawlers.
        </div>
        <div class="card">
    ...
    <div id="help" class="tab-content">
        <div class="card">
            <h1 style="color: #00ffff;">📚 Server Test Suite - Help & Documentation</h1>
            
            <div class="section">
                <div class="section-header" data-section-id="help_overview">
                    <span><strong>📖 Overview - What is this tool?</strong></span>
                    <span id="help_overview_icon" class="section-icon">▼</span>
                </div>
                <div class="section-content" id="help_overview">
                    <p>This is a comprehensive testing suite for web servers, reverse proxies (HAProxy, Nginx), and load balancers. It helps you:</p>
                    <ul>
                        <li>Test server performance (upload/download speeds)</li>
                        <li>Verify proxy configuration (WebSocket, headers, SSL/TLS)</li>
                        <li>Test load balancing (session stickiness, distribution)</li>
                        <li>Simulate different client scenarios (user-agents, custom headers)</li>
                        <li>Monitor health checks and connection limits</li>
                    </ul>
                </div>
            </div>

            <div class="section">
                <div class="section-header" data-section-id="help_quickstart">
                    <span><strong>🚀 Quick Start Guide</strong></span>
                    <span id="help_quickstart_icon" class="section-icon">▼</span>
                </div>
                <div class="section-content" id="help_quickstart">
                    <h3>First Time Setup (2 minutes)</h3>
                    <ol>
                        <li><strong>Server Info Tab:</strong> Click section headers to expand and view your server configuration</li>
                        <li><strong>Download Test:</strong> Try downloading a 10MB file to verify everything works</li>
                        <li><strong>Stress Test:</strong> Run 100 requests to see load distribution</li>
                    </ol>
                    
                    <h3>Testing a New Load Balancer</h3>
                    <ol>
                        <li><strong>HTTP Version:</strong> Check badge in header (should show HTTP/2 if configured)</li>
                        <li><strong>SSL/TLS Info:</strong> Verify certificate and encryption strength</li>
                        <li><strong>Session Stickiness:</strong> Test if sessions route to same server</li>
                        <li><strong>Health Check:</strong> Verify load balancer health check endpoint</li>
                        <li><strong>WebSocket:</strong> Test if WebSocket upgrade works through proxy</li>
                    </ol>
                </div>
            </div>

            <div class="section">
                <div class="section-header" data-section-id="help_features">
                    <span><strong>⚙️ Feature Details</strong></span>
                    <span id="help_features_icon" class="section-icon">▼</span>
                </div>
                <div class="section-content" id="help_features">
                    <h3>📊 Server Info</h3>
                    <p><strong>What:</strong> Displays detailed server configuration, request/response headers, SSL/TLS info, environment variables.</p>
                    <p><strong>Use Case:</strong> Debug proxy settings, verify SSL termination, check forwarded headers.</p>
                    <p><strong>Look For:</strong> HTTP version badge (HTTP/2?), SSL protocol (TLS 1.3?), proxy headers (X-Forwarded-For).</p>
                    
                    <h3>⬇️ Download Test</h3>
                    <p><strong>What:</strong> Generates and downloads files of specified size (1MB-1GB).</p>
                    <p><strong>Use Case:</strong> Test download speeds, verify large file handling, test compression.</p>
                    <p><strong>Tip:</strong> "Random Data" = realistic (doesn't compress), "Zeros" = tests compression, "Text" = tests text streaming.</p>
                    
                    <h3>⬆️ Upload Test</h3>
                    <p><strong>What:</strong> Uploads random data in chunks to test upload speeds.</p>
                    <p><strong>Use Case:</strong> Test upload limits, verify max file size settings, test chunked uploads.</p>
                    <p><strong>Tip:</strong> Larger chunks = faster but use more memory. 1024KB chunks work well for most tests.</p>
                    
                    <h3>🔥 Stress Test</h3>
                    <p><strong>What:</strong> Sends multiple concurrent HTTP requests.</p>
                    <p><strong>Use Case:</strong> Test server capacity, verify load distribution, find connection limits.</p>
                    <p><strong>Expected Results:</strong> All requests should succeed with similar response times. Different backend servers should handle requests (if load balanced).</p>
                    
                    <h3>🔌 WebSocket Test</h3>
                    <p><strong>What:</strong> Establishes WebSocket connection for real-time bidirectional communication.</p>
                    <p><strong>Use Case:</strong> Test WebSocket support through proxy (critical for real-time apps).</p>
                    <p><strong>Common Issue:</strong> Connection fails = proxy blocking WebSocket upgrade. Check proxy config for WebSocket support.</p>
                    
                    <h3>📋 Custom Headers</h3>
                    <p><strong>What:</strong> Adds custom HTTP headers to requests.</p>
                    <p><strong>Use Case:</strong> Test header forwarding, verify authentication headers pass through proxy, test custom routing based on headers.</p>
                    <p><strong>Tip:</strong> Headers are auto-prefixed with "X-Custom-" for safety.</p>
                    
                    <h3>🔄 Session Stickiness</h3>
                    <p><strong>What:</strong> Tests if load balancer maintains session persistence.</p>
                    <p><strong>Use Case:</strong> Verify sessions always route to same backend server.</p>
                    <p><strong>Expected:</strong> "✓ STICKY" with 1 unique server. If you see multiple servers, check load balancer cookie configuration.</p>
                    
                    <h3>⚡ Parallel Connections</h3>
                    <p><strong>What:</strong> Opens multiple connections simultaneously and holds them open.</p>
                    <p><strong>Use Case:</strong> Find connection limits, test keep-alive behavior, verify timeout settings.</p>
                    <p><strong>Tip:</strong> If many connections fail, check server's MaxClients/worker_connections setting.</p>
                    
                    <h3>💚 Health Check</h3>
                    <p><strong>What:</strong> Simulates health check endpoint with configurable responses.</p>
                    <p><strong>Use Case:</strong> Test load balancer health check configuration, simulate server failures.</p>
                    <p><strong>Try:</strong> Status 503 to simulate server down and see if load balancer removes it from pool.</p>
                </div>
            </div>

            <div class="section">
                <div class="section-header" data-section-id="help_troubleshooting">
                    <span><strong>🔧 Troubleshooting</strong></span>
                    <span id="help_troubleshooting_icon" class="section-icon">▼</span>
                </div>
                <div class="section-content" id="help_troubleshooting">
                    <h3>❌ WebSocket Connection Fails</h3>
                    <p><strong>Symptoms:</strong> "Connection failed" or "WebSocket closed immediately"</p>
                    <p><strong>Solutions:</strong></p>
                    <ul>
                        <li>Check if proxy supports WebSocket (HAProxy: add "timeout tunnel 3600s")</li>
                        <li>Verify "Upgrade: websocket" header is forwarded</li>
                        <li>Check firewall isn't blocking WebSocket ports</li>
                    </ul>
                    
                    <h3>❌ Sessions Not Sticky</h3>
                    <p><strong>Symptoms:</strong> Test shows "✗ NOT STICKY" with multiple servers</p>
                    <p><strong>Solutions:</strong></p>
                    <ul>
                        <li>Enable cookie-based persistence in load balancer</li>
                        <li>Check session cookie name matches config</li>
                        <li>Verify cookies aren't being blocked</li>
                        <li>HAProxy: Add "cookie SERVERID insert indirect nocache"</li>
                    </ul>
                    
                    <h3>❌ Upload Fails Immediately</h3>
                    <p><strong>Symptoms:</strong> Upload starts then fails at 0%</p>
                    <p><strong>Solutions:</strong></p>
                    <ul>
                        <li>Check PHP upload_max_filesize and post_max_size settings</li>
                        <li>Verify web server request size limits (Nginx client_max_body_size)</li>
                        <li>Check available disk space</li>
                    </ul>
                    
                    <h3>❌ Parallel Connections Failing</h3>
                    <p><strong>Symptoms:</strong> Many connections show as "Failed"</p>
                    <p><strong>Solutions:</strong></p>
                    <ul>
                        <li>Increase Apache MaxClients or Nginx worker_connections</li>
                        <li>Check proxy connection limits</li>
                        <li>Verify firewall connection tracking limits</li>
                    </ul>
                    
                    <h3>❌ Health Check Timeout</h3>
                    <p><strong>Symptoms:</strong> Health check never completes</p>
                    <p><strong>Solutions:</strong></p>
                    <ul>
                        <li>Reduce delay setting (if using simulated delay)</li>
                        <li>Increase load balancer timeout</li>
                        <li>Check endpoint URL is correct</li>
                        <li>Verify firewall allows health check traffic</li>
                    </ul>
                </div>
            </div>

            <div class="section">
                <div class="section-header" data-section-id="help_haproxy">
                    <span><strong>⚙️ HAProxy Configuration Examples</strong></span>
                    <span id="help_haproxy_icon" class="section-icon">▼</span>
                </div>
                <div class="section-content" id="help_haproxy">
                    <h3>Session Stickiness</h3>
                    <pre>backend web_backend
    balance roundrobin
    cookie SERVERID insert indirect nocache
    server web1 192.168.1.10:80 check cookie web1
    server web2 192.168.1.11:80 check cookie web2</pre>
...
backend websocket_back
    ...
    server ws1 192.168.1.10:8080 check</pre>
    ...
    server web2 192.168.1.11:80 check inter 5s fall 3 rise 2</pre>
                    
                    <h3>Custom Headers</h3>
                    <pre>frontend http_front
    http-request set-header X-HAProxy-Server %[srv_name]
    http-request set-header X-HAProxy-Backend %[be_name]
    http-request set-header X-Real-IP %[src]</pre>
                </div>
            </div>

            <div class="section">
                <div class="section-header" data-section-id="help_tips">
                    <span><strong>💡 Pro Tips</strong></span>
                    <span id="help_tips_icon" class="section-icon">▼</span>
                </div>
                <div class="section-content" id="help_tips">
                    <h3>Browser DevTools (F12)</h3>
                    <ul>
                        <li><strong>Network tab:</strong> See actual requests/responses, timing, headers</li>
                        <li><strong>Console tab:</strong> View application logs and errors</li>
                        <li><strong>Storage/Application tab:</strong> See all cookies including PHPSESSID</li>
                    </ul>
                    
                    <h3>Testing Workflow</h3>
                    <ol>
                        <li>Start with simple tests (Download, Server Info)</li>
                        <li>Verify basic connectivity works</li>
                        <li>Test advanced features (WebSocket, Session Stickiness)</li>
                        <li>Run stress test under realistic load</li>
                        <li>Document results and compare after changes</li>
                    </ol>
                    
                    <h3>Performance Baselines</h3>
                    <ul>
                        <li><strong>Download:</strong> Should match network speed (100MB in ~10s on 100Mbps)</li>
                        <li><strong>Stress Test:</strong> <100ms average for simple requests</li>
                        <li><strong>Health Check:</strong> <50ms response time</li>
                        <li><strong>WebSocket:</strong> Connect in <1s, messages echo instantly</li>
                    </ul>
                    
                    <h3>Security Notes</h3>
                    <ul>
                        <li>This tool is for <strong>testing environments only</strong></li>
                        <li>Don't expose to public internet without authentication</li>
                        <li>Add IP restrictions for production use</li>
            ...
            <div class="section">
                <div class="section-header" data-section-id="help_glossary">
                    <span><strong>📖 Glossary</strong></span>
                    <span id="help_glossary_icon" class="section-icon">▼</span>
                </div>
                <div class="section-content" id="help_glossary">
                    <p><strong>Backend Server:</strong> The actual web server behind a load balancer/proxy.</p>
                    <p><strong>HAProxy:</strong> High Availability Proxy - popular load balancer and reverse proxy.</p>
                    <p><strong>Health Check:</strong> Periodic request to verify server is healthy and accepting traffic.</p>
                    <p><strong>HttpOnly Cookie:</strong> Cookie that JavaScript cannot read (security feature). PHPSESSID is HttpOnly.</p>
                    <p><strong>Load Balancer:</strong> Distributes traffic across multiple backend servers.</p>
                    <p><strong>mTLS:</strong> Mutual TLS - both client and server authenticate with certificates.</p>
                    <p><strong>PHPSESSID:</strong> Cookie that identifies PHP session (set by session_start()).</p>
                    <p><strong>Reverse Proxy:</strong> Server that forwards requests to backend servers (Nginx, HAProxy).</p>
                    <p><strong>Session Stickiness:</strong> Ensuring requests from same client always hit same backend server.</p>
                    <p><strong>SSL/TLS:</strong> Encryption protocols for HTTPS. TLS is newer version of SSL.</p>
                    <p><strong>Tracking ID:</strong> Custom session identifier displayed in header (different from PHPSESSID).</p>
                    <p><strong>WebSocket:</strong> Protocol for real-time bidirectional communication over HTTP.</p>
                    <p><strong>X-Forwarded-For:</strong> Header containing original client IP when behind proxy.</p>
                </div>
            </div>

            <div style="margin-top: 30px; padding: 20px; background: #2d2d2d; border-radius: 5px; border-left: 4px solid #00ffff;">
                <h3 style="color: #00ffff; margin-top: 0;">Need More Help?</h3>
                <p>Check the browser console (F12) for detailed error messages.</p>
                <p>Each feature has a log section showing request/response details.</p>
                <p style="margin-bottom: 0;">For HAProxy configuration, see: <a href="http://www.haproxy.org/" target="_blank" style="color: #8be9fd;">haproxy.org</a></p>
            </div>
        </div>
    </div>
</div>
